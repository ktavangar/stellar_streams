...
OUTPUTDIR = '/data/des81.b/data/tavangar/streams/nora_orbit_model/output/galpot_stream_mcmc_new/dec20/'
# OUTPUTDIR = './'
...
def chi2_eval(mu_phi1cosphi2_prog, mu_phi2_prog, rv_prog, dist_prog, phi2_prog, M_LMC, sigma_track, sigma_vr, mu_alpha_lmc=1.91, mu_delta_lmc=0.229, rv_lmc=262.2, dist_lmc=49970.):
    if M_LMC > 2.:
...
def chi2_worker(mu_phi1cosphi2_prog, mu_phi2_prog, rv_prog, dist_prog, phi2_prog, sigma_track, sigma_vr, mu_alpha_lmc, mu_delta_lmc, rv_lmc, dist_lmc, M_LMC, rs_LMC, tmax, pid):
    ...
    # phi1_track = np.load('../kiyan_phoenix/phoenix_track_phi1.npy')
    # phi2_track = np.load('../kiyan_phoenix/phoenix_track_phi2-2.npy', allow_pickle=True)
    # phi2_track_std = phi2_track - np.load('../kiyan_phoenix/phoenix_track_phi2_lounc.npy')
    phi1_track = np.load('../kiyan_phoenix/phoenix_track_phi1-2.npy')
    phi2_track = np.load('../kiyan_phoenix/phoenix_track.npy')
    phi2_track_std = phi2_track - np.load('../kiyan_phoenix/phoenix_track_lo.npy')

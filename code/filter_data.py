...
def mkpol(mu, age=12.8, z=0.00004, dmu=0.5, C=[0.01, 0.1], E=2., err=None, survey='DES_Y6'):
    if err == None:
        print('Using DES err!')
    ...
    elif survey in ['DES_DR1', 'DES_Y6', 'DECaLS']:
...
def select_isochrone(mag_g, mag_r, err, iso_params=[16.3, 12.8, 0.00004], dmu=0.5, C=[0.01, 0.1], E=2, gmin=None, survey='DECaLS'):
    mu, age, z = iso_params

...
def plot_stream(hpxcube, modulus, stream=None, ends=None, mu_min=14.0, mu_max=20.0, reso=3.0, smoothing=0.15, savedir='decals/density_plots/', save=True, plot_streams=False):
    print(mu_min, mu_max)

...
def plot_hess(data_on, data_off=None, gmax=24, gmin=16, grmax=1, grmin=0, vmin=None, vmax=None, dx=0.1 / 5., dy=0.5 / 6., ax=None, gband='SOF_PSF_MAG_CORRECTED_G', rband='SOF_PSF_MAG_CORRECTED_R', no_bkg=False, smoothing=0.75, weights=None):
    mu=16.25
    gmin, gmax = gmin-mu, gmax-mu
...
def plot_hess_app_mag(data_on, data_off=None, gmax=24, gmin=16, grmax=1, grmin=0, vmin=None, vmax=None, dx=0.1 / 5., dy=0.5 / 6., ax=None, gband='SOF_PSF_MAG_CORRECTED_G', rband='SOF_PSF_MAG_CORRECTED_R', no_bkg=False, smoothing=0.75, weights=None):
    mu=16.25
    gmin, gmax = gmin, gmax
    xbins = np.arange(grmin, grmax + dx, dx)
    ybins = np.arange(gmin, gmax + dy, dy)

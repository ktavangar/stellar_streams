...
if __name__ == '__main__':
    ...
    parser.add_argument('-f', '--filename', default='DESY6_iso_hpxcube_z0.00005_a12.8_gmax24_gmin3p4_E2_C0p010p1.fits.gz')
    ...
    parser.add_argument('-z', '--metallicity', default=0.00005)
